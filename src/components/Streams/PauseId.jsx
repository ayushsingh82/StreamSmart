  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-blue-700 to-blue-200 text-white">
      <div className="w-full max-w-xl p-8 bg-gray-900 rounded-lg shadow-xl">
        <h2 className="text-3xl font-bold mb-8 text-center">Pause Stream</h2>
        ...
        {showNotification && (
          <div className="mt-4 p-4 bg-green-700 border border-green-600 rounded-md flex items-center">
            ...
            <p className="text-md font-semibold">Stream paused</p>
          </div>
        )}
      </div>
    </div>
...
//         `https://api.quicknode.com/streams/rest/v1/streams/${id}/pause`,
//         requestOptions
//       );
...
//       setMessage(`Stream paused successfully: ${JSON.stringify(result)}`);
//       setError(null);
//     } catch (error) {
//       console.error('Error pausing stream:', error);
//       setError('Error pausing stream: ' + error.message);
//       setMessage(null);
//     }
//   };
